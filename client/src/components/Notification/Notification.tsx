...
import { NotificationData } from "@/interfaces/notification.type";
const Notification = () => {
  const { data } = useFetchNotifications();
  const updateNotificationSeen = UpdateNotification();
  const [prevData, setPrevData] = useState<NotificationData[] | null>(null);
